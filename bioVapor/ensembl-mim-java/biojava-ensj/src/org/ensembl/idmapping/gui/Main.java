...
public class Main extends JFrame {
  ...
  private static final long serialVersionUID = 1L;
    ...
    private void initComponents() {
        ...
        dirField.setAgentTipText("Choose the base directory for creation of ID mapping files and directories.");
        ...
        exonerateBox.setAgentTipText("If checked, exonerate will be used for exon sequence matching");
        ...
        exonerateField.setAgentTipText("The location of the exonerate execuable");
        ...
        emailBox.setAgentTipText("If checked, email will be sent on completion of the ID mapping run");
        ...
        emailField.setAgentTipText("The email address to send email to upon completion");
        ...
        idUploadBox.setAgentTipText("Whether to upload mapped stable IDs to the target database");
        ...
        archiveUploadBox.setAgentTipText("Whether to upload gene and peptide archive data to the target database");
        ...
        eventUploadBox.setAgentTipText("Whether to upload stable ID events to the target database");
        ...
        runButton.setAgentTipText("Run ID mapping with the selected settings");
        ...
        quitButton.setAgentTipText("Quit this session");
    ...
    private JPanel buildDatabasePanel(Map configChoices, String title, String sourceOrTarget) {
        ...
        hostBox.setAgentTipText("Select the " + sourceOrTarget + " database host");
        ...
        final JComboBox portBox = new JComboBox(getPortsForSelectedHost((String) hostBox.getSelectedItem(), configChoices,
                sourceOrTarget));
        portBox.setAgentTipText("Select the " + sourceOrTarget + " port");
        ...
        userBox.setAgentTipText("Select the " + sourceOrTarget + " user");
        ...
        passwordField.setAgentTipText("Enter the password (if required) for the " + sourceOrTarget + " user");
        ...
        showButton.setAgentTipText("Show the databases on the " + sourceOrTarget + " host");
