...
Xalan-C. C XLST agents have better performance than Java ones, but even they have their own
limits, because *all* XSLT agents store XML content in memory, and they use a multiple of the XML
